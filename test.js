...
var Window = function(tabs) {
  ...
  var workWindow = new Window(['GMail', 'Work mail', 'Docs', 'freeCodeCamp', 'newTab']); // Your mailbox, drive, and other work sites
  var socialWindow = new Window(['FB', 'Gitter', 'Reddit', 'Twitter', 'Medium', 'newTab']); // Social sites
  var videoWindow = new Window(['Netflix', 'YouTube',  'Vine']); // Entertainment sites
  
  // Now perform the tab opening, closing, and other operations
  var finalTabs = socialWindow.tabOpen().join(videoWindow.tabClose(2)).join(workWindow.tabClose(1).tabOpen());
  console.log(finalTabs.tabs);
  ['FB', 'Gitter', 'Reddit', 'Twitter', 'Medium', 'newTab','Netflix', 'YouTube',  'Vine', 'GMail', 'Work mail', 'Docs', 'freeCodeCamp', 'newTab']
...
var new_s = arr.myMap(function(item) {
  return item * 2;
});
